...
const Deviation = () => {
    ...
    useEffect(() => {
        setLoader(true);
        Axios.get(`normaluser/reason-for-deviation/list_create/?page=${pageStatus.current}`)
            .then(res => {
    ...
    const formSubmit = data => {
        ...
        if (modalStatus === 'add') {
            Axios.post('normaluser/reason-for-deviation/list_create/', data)
                .then(() => {
                    setReload(!reload);
            ...
            Axios.put(`normaluser/reason-for-deviation/retrieve_update_destroy/${specificDeviationId}/`, data)
                .then(() => {
                    setReload(!reload);
    ...
    const deleteHandler = () => {
        ...
        Axios.delete(`normaluser/reason-for-deviation/retrieve_update_destroy/${specificDeviationId}/`)
            .then(() => {
                setReload(!reload);
