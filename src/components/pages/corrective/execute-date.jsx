...
const ExecuteDate = ({ setStep, setAllDetail, allDetail, setIsModalOpen, setReload, chosenEditItemDetails, today }) => {
    ...
    useEffect(() => {
        ...
        console.log("kkkkkk",allDetail?.execute_date);
        console.log("UUUUUUU",chosenEditItemDetails);
    ...
    const formSubmit = data => {
        ...
        if (chosenEditItemDetails) {
            Axios.put(`/normaluser/corrective-action/update/${chosenEditItemDetails.id}/`, formData)
                .then(() => {
                    setReload(prev => !prev);
                    setAllDetail(prev => ({
                        ...prev,
            ...
            Axios.post('/normaluser/corrective-action/list_create/', formData)
                .then(() => {
