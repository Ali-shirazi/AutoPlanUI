    ...
    return (
        <Style>
            <form onSubmit={handleSubmit(formSubmit)}>
                ...
                {
                    chosenEditItemDetails?.file &&
                    <Button variant='conatined' sx={{color : 'white', marginBottom: '20px', marginTop : '20px', backgroundColor: 'blue'}} fullWidth onClick={() => {window.location.href = chosenEditItemDetails.file}} color='primary'>
                        فایل مستند آپلود شده
                    </Button>
                }
