...
const AddPersonnel = ({ setReload, setState, editModalData, modalStatus, subModalCloseHandler }) => {
    ...
    const formSubmit = data => {
        ...
        if (modalStatus === 'edit') {
            Axios.put(`/normaluser/personnel/retrieve_update_destroy/${editModalData.id}/`, newData)
                .then(() => {
                    console.log('addperson-put',newData);
                    setReload(prev => !prev);
                    setState(false);
            ...
            Axios.post('/normaluser/personnel/list_create/', newData)
                .then(() => {
                    console.log('addperson-put',newData);
                    setReload(prev => !prev);
                    setState(false);
