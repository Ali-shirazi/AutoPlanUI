...
const ReceptionForm = () => {
    ...
    const formSubmit = data => {
        ...
        if (sum === 100) {
            setLoading(true);
            if (!addButtonStatus) {
                Axios.post('normaluser/acceptance-settings/list_create/', data)
                    .then(() => {
                        setReload(!reload);
                ...
                Axios.put(`normaluser/acceptance-settings/update/${specificId}/`, data)
                    .then(() => {
                        setReload(!reload);
    ...
    useEffect(() => {
        Axios.get('normaluser/acceptance-settings/list_create/').then(res => {
